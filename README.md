...
2. Get the latest CM 13.0 sources.
...
9. Go grab yourself a coffee. A full build with empty CCache takes around 6 hours on my machine (i5 Dualcore with Hyperthreading, 8 GB RAM and SSD).
10. Once it's finished you can just flash it. Congratulations, you built your own CM 13.0 for the P8000!
