...
WZ_LOCAL_EXTERNAL_SHARED_LIBS := libfpsvcd_remoteapi.so libslbase.so
...
LOCAL_MODULE := libslfpjni
LOCAL_SRC_FILES_64 := src/com_silead_fp_utils_FpControllerNative.cpp src/ainffpsvcfpapkrelayerCB.cpp 
...
#APP_OPTIM := debug
LOCAL_SHARED_LIBRARIES += liblog libnativehelper #libandroid_runtime

LOCAL_JNI_SHARED_LIBRARIES := libslfpjni
#LOCAL_PROGUARD_ENABLED := disabled
LOCAL_MODULE_TAGS := optional
