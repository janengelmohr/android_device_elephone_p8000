...
public class TestActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        write_registerButton.setEnabled(false);
        ...
        calibrationInfo.setText(R.string.calibration_init_test);
	...
	public void onClick(View v) {
		...
		if (v == start_draw_button) {
			if(fp_flag){
				...
				start_draw_button.setText(R.string.end_fpshow_tips_test);
                                calibrationInfo.setText(R.string.calibration_start_test);
			} else {
				
//				silead_fp.silead_fp_DhwInit();
				start_draw_button.setText(R.string.st_fpshow_tips_test);
				//mTimer.cancel();
    ...
    private synchronized void fpDraw(){
    	...
    	if(silead_fp.ReadReg(0) == 1) {
                calibrationInfo.setText(R.string.calibration_end_test);
                if (!"calibration done".equals(addr_register_EditText.getText().toString()))
		    Toast.makeText(this, R.string.calibration_done_test, Toast.LENGTH_SHORT).show();
    		addr_register_EditText.setText("calibration done");
                write_registerButton.setEnabled(true);
        }
